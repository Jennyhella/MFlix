...
?>
    ...
    <style>
        ...
        .card {
            ...
            border: 2px solid rgb(239, 5, 24); /* Add a blue border around the card */
        ...
        .card-img-top {
            ...
            border-bottom: 2px rgb(255, 21, 48); /* Add a border below the image */
        }
        ...
        .card a.btn-outline-light {
            border: 2px solid rgb(251, 37, 17); /* Add a blue border to the button */
            color:rgb(255, 27, 54); /* Blue text color for the button */
            font-weight: bold; /* Make the button text bold */
            transition: all 0.3s ease; /* Add a smooth transition effect */
        }

        .card a.btn-outline-light:hover {
            background-color:rgb(236, 29, 35); /* Blue background on hover */
            color: #fff; /* White text color on hover */
            border-color:rgb(235, 16, 16); /* Darker blue border on hover */
        }
